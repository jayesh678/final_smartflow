...
ActiveRecord::Schema[7.1].define(version: 2024_03_13_012007) do
  ...
  create_table "business_partners", force: :cascade do |t|
    ...
    t.index ["company_id"], name: "index_business_partners_on_company_id"
  ...
  add_foreign_key "business_partners", "companies"
